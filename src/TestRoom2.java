...
public class TestRoom2 {
    ...
    public static void main(String args[]) {
        ...
        BaseRoom r1 = rm.checkIn(rc1,"Suite",amenities);
        ...
        BaseRoom r2 = rm.checkIn(rc2,"Deluxe",amenities2);
        ...
        System.out.println("cost:" + cost);
        BaseRoom r9 = rm.checkIn(rc9,"Regular",amenities2);
        rm.cleanRooms();
    }
}