...
public class MainTester {
	public static void main(String[] args) {
		...
		MotelRoom R3 = Motel.checkIn(RC3, "Suite", A);
		MotelRoom R4 = Motel.checkIn(RC4, "Regular", A2);
		MotelRoom R5 = Motel.checkIn(RC5, "Suite", A);
		MotelRoom R6 = Motel.checkIn(RC6, "Deluxe", A2);
		MotelRoom R7 = Motel.checkIn(RC7, "Deluxe", A);
		MotelRoom R8 = Motel.checkIn(RC8, "Regular", A2);
		MotelRoom R9 = Motel.checkIn(RC9, "Suite", A);
		MotelRoom R10 = Motel.checkIn(RC10, "Regular", A2);
		//WaitList Test
		MotelRoom R11 = Motel.checkIn(RC11, "Deluxe", A);
